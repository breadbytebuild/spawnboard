      ...
      next_steps: [
        ...
        },
        {
          ...
          fields: {
            ...
            html: "HTML content (max 1MB) — uploaded as hosted file for live rendering",
          ...
          note: "Supports PNG, JPG, WebP, SVG, GIF, AVIF. Dimensions are auto-extracted. SVG viewBox is parsed automatically. Screens without canvas_x/canvas_y are auto-laid out in a grid. You can also send 'html' instead of 'image' for HTML screens. Source files (source_html, source_css, context_md) are optional — attach them for live rendering and agent reference.",
        },
        {
          step: 4,
